...
{
    public class ProductsRuleConditionField : EntityBase
    {
        /// <summary>
        /// The ID of the product option this condition will test against. 
        ///See the Product Options resource.
        /// 
        /// int
        /// </summary>
        ...
        ///See the Option Values resource.
        /// 
        /// int
        /// </summary>
        ...
        /// <summary>
        /// The ID of the combination (SKU). 
        ///See the SKU resource.
        /// 
        /// int
        /// </summary>
        [JsonProperty("sku_id")]
